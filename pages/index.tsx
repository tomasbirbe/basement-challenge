    ...
    <div className="xl w-full">
      <div className="flex flex-row justify-between w-full px-5 py-4">
        ...
        <div className="flex flex-row gap-x-4">
          <Image alt="hola" height={22} src="/icons/navbar-icon-1.svg" width={22} />
          <Image alt="hola" height={24} src="/icons/navbar-icon-2.svg" width={42} />
          <Image alt="hola" height={20} src="/icons/navbar-icon-3.svg" width={82} />
          <Image alt="hola" height={24} src="/icons/navbar-icon-4.svg" width={42} />
          <Image alt="hola" height={21} src="/icons/navbar-icon-5.svg" width={24} />
        </div>
